...
const VDCUsers: React.FC = () => {
  ...
  const [selectedUser, setSelectedUser] = useState<VDCUser | null>(null);
    ...
    return (
      <PageSection>
        <EmptyState icon={UsersIcon}>
          ...
          <EmptyStateBody>
            The VDC you're looking for doesn't exist.
          </EmptyStateBody>
          <Button variant="primary" onClick={() => navigate(ROUTES.VDCS)}>
            Back to VDCs
          </Button>
          ...
          <Split hasGutter>
            <SplitItem isFilled>
              ...
              <p className="pf-v6-u-color-200">
                Manage users and roles for {vdc.name}
              </p>
            </SplitItem>
            <SplitItem>
              <Button
          ...
          <Card>
            <CardBody>
              {paginatedUsers.length === 0 ? (
                  ...
                  <EmptyState icon={searchTerm ? SearchIcon : UsersIcon}>
                    ...
                    <EmptyStateBody>
                      {searchTerm
                        ...
                        : 'Get started by inviting your first user to this VDC.'}
                    </EmptyStateBody>
                    {!searchTerm && (
                      <EmptyStateActions>
                        <Button
                ...
                <Table aria-label="VDC users table" variant="compact">
                  <Thead>
                    <Tr>
        ...
        <Form>
          ...
          <FormGroup label="Role" isRequired fieldId="invite-role">
            ...
            >
              <FormSelectOption
                value="admin"
                label="Admin - Full VDC access and management"
              />
              <FormSelectOption
                value="user"
                label="User - Can create and manage VMs"
              />
              <FormSelectOption
                value="viewer"
